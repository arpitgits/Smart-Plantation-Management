...
class MQTTmanager (val connectionParams: MQTTConnectionParams, context: Context, val uiUpdater: UIUpdaterInterface?) {

    private var client = MqttAndroidClient(context,connectionParams.host,connectionParams.clientId + this.id(context))
